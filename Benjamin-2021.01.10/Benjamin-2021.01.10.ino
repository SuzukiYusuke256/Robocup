...
#define MAXPOWER 255 * 0.5  //モーターの最大パワー
...
void getLine() {
    const int threshold[8] = {750, 750, 750, 750, 750, 750, 800, 800};
    int line[8] = {0};
    for (byte i = 0; i < 8; i++) {
...
void wrapAroundBall() {
    const double plusDeg = 42.0, goForwardDeg = 10.0, ratio = pow(12, (ballDistance / 85) - 1);
    if (ballDeg == 1000.0) {
        moveDeg == 1000.0;
